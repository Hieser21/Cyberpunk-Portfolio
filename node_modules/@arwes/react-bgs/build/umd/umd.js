...
const Dots = (props) => {
    ...
    return (react_1.default.createElement("canvas", { ref: (0, react_tools_1.mergeRefs)(elementRef, elementRefExternal), className: (0, tools_1.cx)('arwes-react-bgs-dots', className), style: {
            position: 'absolute',
            left: 0,
            top: 0,
            display: 'block',
...
const GridLines = (props) => {
    ...
    return (react_1.default.createElement("canvas", { ref: (0, react_tools_1.mergeRefs)(elementRef, elementRefExternal), className: (0, tools_1.cx)('arwes-react-bgs-gridlines', className), style: {
            position: 'absolute',
            left: 0,
            top: 0,
            display: 'block',
...
const MovingLines = (props) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        const animatorSubscription = (node) => {
            ...
            switch (state) {
                case entering: {
                    transitionControl = (0, motion_1.animate)(canvas, { opacity: [0, 1] }, { duration: duration === null || duration === void 0 ? void 0 : duration.enter, easing: 'ease-out' });
                    intervalControl = (0, motion_1.animate)(draw, { duration: duration === null || duration === void 0 ? void 0 : duration.interval, easing: 'linear', repeat: Infinity });
                    break;
                }
                case exiting: {
                    transitionControl = (0, motion_1.animate)(canvas, { opacity: [1, 0] }, { duration: duration === null || duration === void 0 ? void 0 : duration.exit, easing: 'ease-out' });
    ...
    return (react_1.default.createElement("canvas", { ref: (0, react_tools_1.mergeRefs)(elementRef, elementRefExternal), className: (0, tools_1.cx)('arwes-react-bgs-movinglines', className), style: {
            position: 'absolute',
            left: 0,
            top: 0,
            display: 'block',
...
const Puffs = (props) => {
    ...
    return (react_1.default.createElement("canvas", { ref: (0, react_tools_1.mergeRefs)(elementRef, elementRefExternal), className: (0, tools_1.cx)('arwes-react-bgs-puffs', className), style: {
            position: 'absolute',
            left: 0,
            top: 0,
            display: 'block',
