...
const index_1 = __webpack_require__(/*! ../internal/AnimatorContext/index */ "./src/internal/AnimatorContext/index.ts");
const index_2 = __webpack_require__(/*! ../internal/AnimatorGeneralContext/index */ "./src/internal/AnimatorGeneralContext/index.ts");
...
const Animator = (props) => {
    ...
    const [isExited, setIsExited] = (0, react_1.useState)(undefined);
    ...
    return (0, react_1.createElement)(index_1.AnimatorContext.Provider, { value: animatorInterface }, unmountOnExited && (isExited || (animatorInterface === null || animatorInterface === void 0 ? void 0 : animatorInterface.node.state) === animator_1.ANIMATOR_STATES.exited)
        ? null
        : children);
};
...
/***/ "./src/Animator/Animator.types.ts":
/*!****************************************!*\
  !*** ./src/Animator/Animator.types.ts ***!
  \****************************************/
...
const Animator_1 = __webpack_require__(/*! ./Animator */ "./src/Animator/Animator.ts");
// TODO: Optimize props comparision.
const Animator = (0, react_tools_1.memo)(Animator_1.Animator);
exports.Animator = Animator;
tslib_1.__exportStar(__webpack_require__(/*! ./Animator.types */ "./src/Animator/Animator.types.ts"), exports);


/***/ }),

/***/ "./src/AnimatorGeneralProvider/AnimatorGeneralProvider.ts":
/*!****************************************************************!*\
  !*** ./src/AnimatorGeneralProvider/AnimatorGeneralProvider.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const react_1 = __webpack_require__(/*! react */ "../../scripts/pkg-build-umd-mocks/react.js");
const index_1 = __webpack_require__(/*! ../internal/AnimatorGeneralContext/index */ "./src/internal/AnimatorGeneralContext/index.ts");
...
/***/ "./src/AnimatorGeneralProvider/AnimatorGeneralProvider.types.ts":
/*!**********************************************************************!*\
  !*** ./src/AnimatorGeneralProvider/AnimatorGeneralProvider.types.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/AnimatorGeneralProvider/index.ts":
/*!**********************************************!*\
  !*** ./src/AnimatorGeneralProvider/index.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
const react_tools_1 = __webpack_require__(/*! @arwes/react-tools */ "../../scripts/pkg-build-umd-mocks/arwes/react-tools.js");
const AnimatorGeneralProvider_1 = __webpack_require__(/*! ./AnimatorGeneralProvider */ "./src/AnimatorGeneralProvider/AnimatorGeneralProvider.ts");
// TODO: Optimize props comparision.
const AnimatorGeneralProvider = (0, react_tools_1.memo)(AnimatorGeneralProvider_1.AnimatorGeneralProvider);
exports.AnimatorGeneralProvider = AnimatorGeneralProvider;
tslib_1.__exportStar(__webpack_require__(/*! ./AnimatorGeneralProvider.types */ "./src/AnimatorGeneralProvider/AnimatorGeneralProvider.types.ts"), exports);
...
tslib_1.__exportStar(__webpack_require__(/*! ./Animator/index */ "./src/Animator/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__(/*! ./useAnimator/index */ "./src/useAnimator/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__(/*! ./AnimatorGeneralProvider/index */ "./src/AnimatorGeneralProvider/index.ts"), exports);
tslib_1.__exportStar(__webpack_require__(/*! ./useAnimatorGeneral/index */ "./src/useAnimatorGeneral/index.ts"), exports);


/***/ }),

/***/ "./src/internal/AnimatorContext/AnimatorContext.ts":
/*!*********************************************************!*\
  !*** ./src/internal/AnimatorContext/AnimatorContext.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const react_1 = __webpack_require__(/*! react */ "../../scripts/pkg-build-umd-mocks/react.js");
const AnimatorContext = (0, react_1.createContext)(undefined);
exports.AnimatorContext = AnimatorContext;


/***/ }),

/***/ "./src/internal/AnimatorContext/index.ts":
/*!***********************************************!*\
  !*** ./src/internal/AnimatorContext/index.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./AnimatorContext */ "./src/internal/AnimatorContext/AnimatorContext.ts"), exports);


/***/ }),

/***/ "./src/internal/AnimatorGeneralContext/AnimatorGeneralContext.ts":
/*!***********************************************************************!*\
  !*** ./src/internal/AnimatorGeneralContext/AnimatorGeneralContext.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const react_1 = __webpack_require__(/*! react */ "../../scripts/pkg-build-umd-mocks/react.js");
const AnimatorGeneralContext = (0, react_1.createContext)(undefined);
exports.AnimatorGeneralContext = AnimatorGeneralContext;


/***/ }),

/***/ "./src/internal/AnimatorGeneralContext/index.ts":
/*!******************************************************!*\
  !*** ./src/internal/AnimatorGeneralContext/index.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./AnimatorGeneralContext */ "./src/internal/AnimatorGeneralContext/AnimatorGeneralContext.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./useAnimator */ "./src/useAnimator/useAnimator.ts"), exports);


/***/ }),

/***/ "./src/useAnimator/useAnimator.ts":
/*!****************************************!*\
  !*** ./src/useAnimator/useAnimator.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const index_1 = __webpack_require__(/*! ../internal/AnimatorContext/index */ "./src/internal/AnimatorContext/index.ts");
const useAnimator = () => {
    return (0, react_1.useContext)(index_1.AnimatorContext);
};
...
/***/ "./src/useAnimatorGeneral/index.ts":
/*!*****************************************!*\
  !*** ./src/useAnimatorGeneral/index.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(/*! tslib */ "../../node_modules/tslib/tslib.es6.js");
tslib_1.__exportStar(__webpack_require__(/*! ./useAnimatorGeneral */ "./src/useAnimatorGeneral/useAnimatorGeneral.ts"), exports);


/***/ }),

/***/ "./src/useAnimatorGeneral/useAnimatorGeneral.ts":
/*!******************************************************!*\
  !*** ./src/useAnimatorGeneral/useAnimatorGeneral.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const useAnimatorGeneral = () => {
    return (0, react_1.useContext)(index_1.AnimatorGeneralContext);
};
