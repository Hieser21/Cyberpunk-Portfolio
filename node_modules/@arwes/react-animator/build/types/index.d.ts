declare module '@arwes/react-animator/Animator/Animator' {
...
declare module '@arwes/react-animator/AnimatorGeneralProvider/AnimatorGeneralProvider' {
  import { type ReactElement } from 'react';
  import { type AnimatorGeneralProviderProps } from '@arwes/react-animator/AnimatorGeneralProvider/AnimatorGeneralProvider.types';
  const AnimatorGeneralProvider: (props: AnimatorGeneralProviderProps) => ReactElement;
  export { AnimatorGeneralProvider };

}
declare module '@arwes/react-animator/AnimatorGeneralProvider/AnimatorGeneralProvider.types' {
...
declare module '@arwes/react-animator/AnimatorGeneralProvider/index' {
  /// <reference types="react" />
  const AnimatorGeneralProvider: (props: import("@arwes/react-animator/AnimatorGeneralProvider/AnimatorGeneralProvider.types").AnimatorGeneralProviderProps) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
  export * from '@arwes/react-animator/AnimatorGeneralProvider/AnimatorGeneralProvider.types';
  export { AnimatorGeneralProvider };
